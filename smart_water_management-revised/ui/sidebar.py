...
class Sidebar(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_stop_simulation = QPushButton("Stop Simulation")

        for btn in [self.btn_add_node, self.btn_connect, self.btn_prim, self.btn_simulate, self.btn_show_graph, self.btn_remove_node, self.btn_disconnect_edge, self.btn_move_node, self.btn_pan_zoom, self.btn_save_map, self.btn_load_map, self.btn_stop_simulation]:
